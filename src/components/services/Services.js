          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                ...
                websites. Ensuring that sites meet user expectations by ensuring
              ...
              <ul className="services__modal-services grid">
                ...
                <li className="services__modal-service">
                  ...
                  ></i>
                  <p className="services__modal-info">
                    Coding well designed, testable, efficient code by using
              ...
              {/* button */}
              <a href="#contact" className="button button--flex services__button2">
                Say Hello
                <svg
                  class="button__icon"
